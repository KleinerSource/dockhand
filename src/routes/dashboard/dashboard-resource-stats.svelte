...
<div class="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
	<div class="flex items-center justify-between">
		<span class="flex items-center gap-1 text-muted-foreground">
			<Image class="w-3 h-3" /> {$t('common.labels.images')}
		</span>
	...
	<div class="flex items-center justify-between">
		<span class="flex items-center gap-1 text-muted-foreground">
			<Layers class="w-3 h-3" /> {$t('common.labels.stacks')}
		</span>
	...
	<div class="flex items-center justify-between">
		<span class="flex items-center gap-1 text-muted-foreground">
			<HardDrive class="w-3 h-3" /> {$t('common.labels.volumes')}
		</span>
	...
	<div class="flex items-center justify-between">
		<span class="flex items-center gap-1 text-muted-foreground">
			<Network class="w-3 h-3" /> {$t('common.labels.networks')}
		</span>
