			...
			<div class="flex items-center justify-between">
				<div class="flex items-center gap-3">
					<div class="flex items-center gap-2">
						...
						<div>
							<Dialog.Title class="text-sm font-semibold text-zinc-800 dark:text-zinc-100">{$t("networks.graph.modalTitle")}</Dialog.Title>
							<Dialog.Description class="text-xs text-zinc-500 dark:text-zinc-400">{$t("networks.graph.modalDescription")}</Dialog.Description>
						</div>
					</div>
				</div>
